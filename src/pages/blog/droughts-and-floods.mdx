...
The mentor to *soon-to-be mentee* ratio is kind of skewed. About 1 mentor for every 3 *mentee*s. Most *mentee*s won't get a mentor. The ratio gets even worse as mentors leave the platform. 

Really, the biggest problem right now is mentors, with their easy access to *mentee*s, quickly finding a match and heading out. The *mentee*s will stay as long as it looks like they're just about to find the mentor of their dreams. You need to keep the mentors on the platform.
